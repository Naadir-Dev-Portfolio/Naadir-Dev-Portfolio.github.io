/* ============================================================
   ...
   Last compiled: (GitHub Actions will update this line)
   ============================================================ */
window.__PORTFOLIO = {
  ...
  DATA: {
    ...
    python: {
      desktop: [
        { n:1, title:'Finance Dashboard', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Finance-Dashboard/main/portfolio/FinanceScreen.png', imgs:['https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Finance-Dashboard/main/portfolio/FinanceScreen.png','https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Finance-Dashboard/main/portfolio/financeDashboard.jpg','https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Finance-Dashboard/main/portfolio/eer.webp'], desc:'Interactive finance KPIs dashboard with automated data importing, charting and portfolio tracking — built with PyQt6.', code:'https://github.com/Naadir-Dev-Portfolio/Finance-Dashboard/blob/main/Ui_finance.py', details:'https://github.com/Naadir-Dev-Portfolio/Finance-Dashboard/blob/main/README.md', tags:['python','pyqt','data-viz'] },
        { n:2, title:'YouTube Stats Dashboard', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/YouTube-Stats-Dashboard/main/portfolio/yt_viewCountScreen.webp', desc:'Cross-platform PyQt6 dashboard integrating the YouTube Data API to visualise channel growth and engagement trends.', code:'https://github.com/Naadir-Dev-Portfolio/YouTube-Stats-Dashboard/blob/main/main.py', details:'https://github.com/Naadir-Dev-Portfolio/YouTube-Stats-Dashboard/blob/main/README.md', tags:['python','pyqt','api'] },
        { n:3, title:'Health Dashboard', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Health-Dashboard/main/portfolio/healthDashboardScreen.png', desc:'OpenGL-powered health metrics dashboard with dynamic 3D body model selection and vitals tracking.', code:'https://github.com/Naadir-Dev-Portfolio/Health-Dashboard/blob/main/Ui_health.py', details:'https://github.com/Naadir-Dev-Portfolio/Health-Dashboard/blob/main/README.md', tags:['python','pyqt','opengl'] },
        { n:4, title:'Mortgage Overpayment Tracker', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Mortgage-Overpayment-Tracker/main/portfolio/mortgageTrackerScreen.webp', desc:'Amortisation simulation tool — model overpayment scenarios, see interest saved and payoff date at a glance.', code:'https://github.com/Naadir-Dev-Portfolio/Mortgage-Overpayment-Tracker/blob/main/main.py', details:'https://github.com/Naadir-Dev-Portfolio/Mortgage-Overpayment-Tracker/blob/main/README.md', tags:['python','finance'] },
    ...
    web: {
      teamsites: [
        { n:1, title:'Team Hub Website', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Team-Hub-Website/main/portfolio/ccmisite_demo.webp', desc:'Professional front-end portal for an internal data team — showcasing tools, projects and team info with a clean, responsive layout.', code:'https://github.com/Naadir-Dev-Portfolio/Team-Hub-Website/tree/main', demo:'https://ccmiteamsite-by-naadir.netlify.app/', details:'https://github.com/Naadir-Dev-Portfolio/Team-Hub-Website/blob/main/README.md', tags:['web','html','css','js'] },
        { n:2, title:'Power BI Request Portal', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/PowerBI-Request-Portal/main/portfolio/pbirequest.webp', desc:'Interactive request portal that walks stakeholders through the Power BI report commissioning process — replaces email back-and-forth.', code:'https://github.com/Naadir-Dev-Portfolio/PowerBI-Request-Portal/blob/main/index.html', demo:'https://powerbirequest-by-naadir.netlify.app/', details:'https://github.com/Naadir-Dev-Portfolio/PowerBI-Request-Portal/blob/main/README.md', tags:['web','html','powerbi'] },
      ...
      tools:    [],
      cognitive: [
        { n:1, title:'Rain Drops Arithmetics', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/RainDrops/main/portfolio/raindropsScreen.webp', desc:"Fast-paced arithmetic training game inspired by Lumosity's Rain Drops — tests mental calculation speed under pressure.", code:'https://github.com/Naadir-Dev-Portfolio/RainDrops/blob/main/index.html', demo:'https://raindrops-by-naadir.netlify.app/', tags:['web','js','game'] },
        { n:2, title:'Hexamatch Fractions', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Hexamatch/main/portfolio/hexamatchScreen.webp', desc:'Hexagonal tile-matching game that builds intuitive understanding of equivalent fractions through play.', code:'https://github.com/Naadir-Dev-Portfolio/Hexamatch/blob/main/index.html', demo:'https://hexamatch-by-naadir.netlify.app/', tags:['web','js','game'] },
        { n:3, title:'AlgebraVerse', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/Algebraverse/main/portfolio/algebraverseScreen.webp', desc:'Progressive algebra challenge system — from basic equations to multi-step problem solving, with difficulty scaling.', code:'https://github.com/Naadir-Dev-Portfolio/Algebraverse/blob/main/index.html', demo:'https://algebraverse-by-naadir.netlify.app/', tags:['web','js','game'] },
        { n:4, title:'Logic Grid Boolean', img:'https://raw.githubusercontent.com/Naadir-Dev-Portfolio/LogicGrid/main/portfolio/logicgridscreen.webp', desc:'Visual boolean logic gate puzzle — helps players build intuitive understanding of AND, OR and NOT operations.', code:'https://github.com/Naadir-Dev-Portfolio/LogicGrid/blob/main/index.html', demo:'https://logicgrid-by-naadir.netlify.app/', tags:['web','js','game'] }
      ]
    },
