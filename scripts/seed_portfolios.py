...
SEED_DATA = {
    ...
    'web': {
        'independent-projects': [
            {'n':1,'title':'Economics Dashboard Web','img':'','desc':'Interactive browser-based economics dashboard - live macro data, yield curves, housing, employment and inflation. Currently in development.','code':'https://github.com/Naadir-Dev-Portfolio/Economics-Dashboard-Web','details':'https://github.com/Naadir-Dev-Portfolio/Economics-Dashboard-Web/blob/main/README.md','tags':['web','js','economics','data-viz']},
        ],
        'business-solutions': [
            {'n':2,'title':'Internal Team Portal','img':'ccmisite_demo.webp','desc':'Professional front-end portal for an internal data team - showcasing tools, projects and team info with a clean, responsive layout.','code':'https://github.com/Naadir-Dev-Portfolio/internal-team-portal/tree/main','demo':'https://ccmiteamsite-by-naadir.netlify.app/','details':'https://github.com/Naadir-Dev-Portfolio/internal-team-portal/blob/main/README.md','tags':['web','html','css','js']},
